...
export function RetroGrid({
  ...
  return (
    <div
      className={cn(
        "pointer-events-none absolute w-full h-[70%] overflow-hidden [perspective:200px]",
        `opacity-[var(--opacity)]`,
        className,
      )}
      style={gridStyles}
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#161513] to-transparent to-90% dark:from-black" />
    </div>
  );
}
